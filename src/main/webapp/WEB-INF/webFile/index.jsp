...
%>
  ...
  <div id="vue-panel" v-cloak>
    <div class="layui-layout layui-layout-admin">
        <!--头部区域-->
        <div class="layui-header" style="min-height: 80px" v-bind:style="{background:headerBgColor}">
            <div id="top" v-bind:style="{background:headerBgColor}">
                ...
                <div class="MaterialInfo-panel">
                    ...
                    <div class="Sysmsg-panel">
                        <!--图标-->
                        <div class="ico-panel">
                            <i class="layui-icon layui-icon-notice" style="font-size: 30px;color: white"></i>
                        </div>
                        <div class="num-panel">
                            <span>{{msgNum}}</span>
                        </div>
        ...
        <div class="layui-side" style="top: 80px;" v-bind:style="{background:navColor}">
            <div class="layui-side-scroll">
                <div class="nav" v-bind:style="{background:navColor}">
                    <div class="nav-top">
                        <div id="mini" style="border-bottom:1px solid rgba(255,255,255,.1)"><img src="img/mini.png">
                        </div>
                    </div>
                    <ul>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="javascript:;"><i class="my-icon nav-icon iconfont icon-dingdandaifukuan"></i><span>订单管理</span><i
                                    class="my-icon nav-more iconfont icon-arrow-right"></i></a>
                            <ul>
                        ...
                        <li class="nav-item">
                            <a href="javascript:;"><i class="my-icon nav-icon iconfont icon-tongjibaobiao"></i><span>统计报表</span><i
                                    class="my-icon nav-more iconfont icon-arrow-right"></i></a>
                            <ul>
                        ...
                        <li class="nav-item">
                            <a href="javascript:;"><i class="my-icon nav-icon iconfont icon-yuangongguanli"></i><span>员工管理</span><i
                                    class="my-icon nav-more iconfont icon-arrow-right"></i></a>
                            <ul>
        ...
        <!--财务报表-->
        <div class="layui-body" v-bind:style="{display:financeReportStatus}" style="top: 80px;">
            <!--当前总收入 当前总支出 当前总余额-->
                    ...
                    <div class="title-toolbar">
                        <div class="elem-panel">
                            <div class="input-panel">
                                <input id="startTime" readonly="readonly" type="text" placeholder="点击选择开始时间" autocomplete="off" class="layui-input">
                            </div>
                            <div class="text-panel">
                                <span>至</span>
                            </div>
                            <div class="input-panel">
                                <input id="endTime" readonly="readonly" type="text" placeholder="点击选择结束时间" autocomplete="off" class="layui-input">
                            </div>
                            <div class="btn-panel">
        ...
        <!--订单信息管理-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:orderManagementStatus}">
            <div class="padding15-panel">
        ...
        <!--进货管理-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:IncomingGoodsStatus}">
            <div class="padding15-panel">
                <div class="layui-row content-panel" id="IncomingGoods-panel">
                    ...
                    <!--进货管理tab选项卡-->
                    <div class="layui-tab layui-tab-brief" lay-filter="IncomingGoodsTab">
                                    ...
                                    <div class="layui-col-md3">
                                        <div class="item-panel layui-form">
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <select lay-search="" lay-filter="" name="SingleNumberSelectPanel">
                                    ...
                                    <div class="layui-col-md3">
                                        <div class="item-panel layui-form">
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">日期</label>
                                                <div class="layui-input-block">
                                                    <input id="originalFilmPurchaseDate" type="text" style="cursor: pointer;" readonly="readonly" placeholder="点击选择时间" autocomplete="off" class="layui-input">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="layui-col-md3">
                                        <div class="item-panel layui-form">
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <select lay-search="" lay-filter="" name="supplierSelectPanel">
                                    ...
                                    <div class="layui-col-md3">
                                        <div class="item-panel layui-form">
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">备注</label>
                                                <div class="layui-input-block">
                                                    <select lay-search="" lay-filter="test" name="originalFilmremarkSelectPanel">
                                                        <option value="">直接选择或手动输入</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="layui-col-md3">
                                            <div class="item-panel layui-form">
                                                <div class="layui-form-item">
                                                    <label class="layui-form-label">单号</label>
                                                    <div class="layui-input-block">
                                                        <select lay-search="" lay-filter="" name="annexoddNumberSelectPanel">
                                                            <option value="">直接选择或手动输入单号</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="layui-col-md3">
                                            <div class="item-panel layui-form">
                                                <div class="layui-form-item">
                                                    <label class="layui-form-label">日期</label>
                                                    <div class="layui-input-block">
                                                        <input id="attachmentProcurementDate" type="text" style="cursor: pointer;" readonly="readonly" placeholder="点击选择时间" autocomplete="off" class="layui-input">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="layui-col-md3">
                                            <div class="item-panel layui-form">
                                                <div class="layui-form-item">
                                                    <label class="layui-form-label">供货商</label>
                                                    <div class="layui-input-block">
                                                        <select lay-search="" lay-filter="" name="annexsupplierSelectPanel">
                                                            <option value="">直接选择或手动输入</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="layui-col-md3">
                                            <div class="item-panel layui-form">
                                                <div class="layui-form-item">
                                                    <label class="layui-form-label">备注</label>
                                                    <div class="layui-input-block">
                                                        <select lay-search="" lay-filter="test" name="annexRemarksSelectPanel">
                                                            <option value="">直接选择或手动输入</option>
                                                        </select>
                                                    </div>
                                                </div>
        ...
        <!--出货管理-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:shipmentStatus}">
            <div class="padding15-panel">
                        ...
                        <div class="btnCondition-panel">
                            ...
                            <div class="dateQuery-panel">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">日期</label>
                                    <div class="layui-input-block">
                                        <input style="cursor: pointer" id="outOfTheLibraryDate" type="text" name="title" readonly="readonly" placeholder="点击选择日期" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                            </div>
                            <!--产品名称查询-->
                            <div class="ProductNameCheck-panel layui-form">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select lay-search="" lay-filter="" name="outOfTheLibraryproductNameSelectPanel">
        ...
        <!--库存管理-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:stockStatus}">
            <div class="padding15-panel">
                        ...
                        <div class="layui-col-md3">
                            <div class="item-panel layui-form">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">产品名称</label>
                                    <div class="layui-input-block">
                                        <select lay-search="" lay-filter="" name="stockProductNameSelectPanel">
                        ...
                        <div class="layui-col-md3">
                            <div class="item-panel layui-form">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select lay-search="" lay-filter="test" name="stockspecificationSelectPanel">
                        ...
                        <div class="layui-col-md3">
                            <div class="item-panel layui-form">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select lay-search="" lay-filter="test" name="stockTextureSelectPanel">
                        ...
                        <div class="layui-col-md3">
                            <div class="item-panel layui-form">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select lay-search="" lay-filter="test" name="stockthicknessSelectPanel">
        ...
        <!--订单月结管理-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:OrderMonthStatus}">
            <div class="padding15-panel">
                <div class="layui-row content-panel" id="OrderMonth-panel">
                        ...
                        <div class="condition-panel">
                            <div class="text-panel">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select lay-search="" lay-filter="" name="OrderMonthSelectPanel">
                    ...
                    <div class="layui-row OrderMonthListBtn-panel">
                        <div class="btn-panel">
                            <button class="layui-btn layui-btn-normal" v-bind:style="{background:BtnColor}">收款登记</button>
                            <button class="layui-btn layui-btn-normal" v-bind:style="{background:BtnColor}">导出月单</button>
                            <button class="layui-btn layui-btn-normal" v-bind:style="{background:BtnColor}">报表</button>
                        </div>
                    </div>
        ...
        <!--客户信息管理-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:CustomerInfoStatus}">
            <div class="padding15-panel">
                <div class="layui-row content-panel" id="CustomerInfo-panel">
                        ...
                        <div class="layui-col-md3">
                            <div class="item-panel layui-form">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <select lay-search="" lay-filter="" name="customerNameSelectPanel">
                        ...
                        <div class="layui-col-md3">
                            <div class="item-panel layui-form">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">日期</label>
                                    <div class="layui-input-block">
                                        <input id="customerInfoDateInput" type="text" style="cursor: pointer;" readonly="readonly" placeholder="点击选择时间段筛选客户" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="layui-row btnParent-panel">
                        <div class="btn-panel">
                            <button class="layui-btn layui-btn-normal" v-bind:style="{background:BtnColor}">新增客户</button>
                            <button class="layui-btn layui-btn-normal" v-bind:style="{background:BtnColor}">删除客户</button>
                            <button class="layui-btn layui-btn-normal" v-bind:style="{background:BtnColor}">客户编辑</button>
                        </div>
                    </div>
                    <!--数据表格区域-->
    ...
    <%=Version%>
        ...
        <!--收入管理-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:revenueInfoStatus}">
            <div class="padding15-panel">
                <div class="layui-row content-panel" id="revenueInfo-panel">
                        ...
                        <div class="layui-col-md3">
                            <div class="item-panel layui-form">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">日期</label>
                                    <div class="layui-input-block">
                                        <input id="revenueInfoDateInput" type="text" style="cursor: pointer;" readonly="readonly" placeholder="点击选择时间段筛选收入记录" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="layui-row btnParent-panel">
                        <div class="btn-panel">
                            ...
                            <button class="layui-btn layui-btn-normal" v-bind:style="{background:BtnColor}">打印</button>
                        </div>
                    </div>
                    <!--数据表格区域-->
        ...
        <!--支出管理-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:expenditureInfoStatus}">
            <div class="padding15-panel">
                        ...
                        <div class="layui-col-md3">
                            <div class="item-panel layui-form">
                                <div class="layui-form-item">
                                    <label class="layui-form-label">日期</label>
                                    <div class="layui-input-block">
                                        <input id="expenditureInfoDateInput" type="text" style="cursor: pointer;" readonly="readonly" placeholder="点击选择时间段筛选支出记录" autocomplete="off" class="layui-input">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!--客户对账-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:customerReconciliationStatus}">
            <div class="padding15-panel" id="customerReconciliation-panel">
                <div class="layui-row content-panel" style="margin-bottom: 10px">
                    ...
                    <div class="customerReconciliationList-panel">
                        <table id="customerReconciliationList" lay-filter="customerReconciliationList"></table>
                    </div>
                </div>
                <div class="layui-row content-panel">
        ...
        <!--考勤管理-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:AttendanceInfoStatus}">
            <div class="padding15-panel">
                            ...
                            <div class="layui-col-md3">
                                <div class="item-panel layui-form">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <select lay-search="" lay-filter="" name="departmentSelectPanel">
                            ...
                            <div class="layui-col-md3">
                                <div class="item-panel layui-form">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <select lay-search="" lay-filter="" name="AttendanceNameSelectPanel">
                            ...
                            <div class="layui-col-md3">
                                <div class="item-panel layui-form">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <select lay-search="" lay-filter="" name="AttendanceJobNumberSelectPanel">
        ...
        <!--工资发放-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:salaryGivingStatus}">
            <div class="padding15-panel">
        ...
        <!--员工信息-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:employeeInfoStatus}">
            <div class="padding15-panel">
        ...
        <!--原片信息-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:OriginalInfoStatus}">
            <div class="padding15-panel">
                            ...
                            <div class="layui-col-md3">
                                <div class="item-panel layui-form">
                                    <div class="layui-form-item">
                                        <label class="layui-form-label">产品名称</label>
                                        <div class="layui-input-block">
                                            <select lay-search="" lay-filter="" name="OriginalInfoproductNameSelectPanel">
        ...
        <!--附件信息-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:AttachmentInfoStatus}">
            <div class="padding15-panel">
                            ...
                            <div class="layui-col-md3">
                                <div class="item-panel layui-form">
                                    <div class="layui-form-item">
                                        ...
                                        <div class="layui-input-block">
                                            <select lay-search="" lay-filter="" name="OriginalInfoCommodityNameSelectPanel">
        ...
        <!--基本设置-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:basicSettingsStatus}">
            <div class="padding15-panel">
                    ...
                    <div class="layui-row cardParent-panel layui-col-space10">
                        <form class="layui-form" action="">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" required  lay-verify="required" placeholder="佰益中空玻璃企业管理系统" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
        ...
        <!--联系我们-->
        <div class="layui-body" style="top: 80px;" v-bind:style="{display:contactUsStatus}">
            <div class="padding15-panel">
