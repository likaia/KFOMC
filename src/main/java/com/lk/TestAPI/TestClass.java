...
public class TestClass
{
	public static void main(String[] args)
	{
		 ...
		 String aa  = "每一天,每一分钟,每一秒,一个人的每一天都很迷茫";
		 aa= aa.replaceAll("每", "");
...
/*		// 打开连接
		...
		shipRow.setOperator("李凯");
		shipRow.setOrderNumber("11413809773");
		List<ShipmentInfo> shipResultList = shipmentMapper.conditionalQuery(shipRow);
		JSONArray ShipResult = new JSONArray(shipResultList);
		System.out.println(ShipResult);
		sqlSession.close();*/
